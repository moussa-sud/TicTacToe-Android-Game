...
public class MainActivity extends AppCompatActivity {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(c1==0) {
                    ...
                    // we call winning game every time we press button
    ...
    private void winningGame() {
        ...
        // if the player x selects 1 , 2 and three buttons the message appears
        ...
        if((b1==1) && (b2==1) && (b3==1)){
            ...
            // here we show the message to the player X

            alertDialog.show();

            // the xCount increase the number on score
            xCount++;
            scoreo.setText(String.valueOf(xCount));
        }
        ...
        else  if((b3==0) && (b6==0) && (b9==0))  // 6
        {
            ...
            alertDialog.show();
            oCount++;
            scoreo.setText("Player Y:"+String.valueOf(oCount));

        }
        else  if((b1==0) && (b5==0) && (b9==0))  // 7
        {
        ...
        else
        {
            ...
            {
                AlertDialog.Builder builder=new AlertDialog.Builder(this);
                builder.setMessage("No One Wins !! Try again ").setCancelable(false).setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        button1.setImageDrawable(null);
                        button2.setImageDrawable(null);
    ...
    {
        // In here if the StartGame variable is equals to X
        // it will change repetitively when the method called
    ...
    private void resetValues() {
          ...
          // here we reset all the values to the default
